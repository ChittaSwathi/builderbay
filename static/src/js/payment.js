odoo.define('builderbay.payment_form', function (require) {
"use strict";

var BSPayment = require('payment.payment_form');
BSPayment.include({
    /**
     * @private
     * @param {Event} ev
                ...
                if ($tx_url.length === 1) {
                    ...
                    return this._rpc({
                        ...
                        params: {
                            ...
                            'utr_no': $('.o_payment_acquirer_select input#utr_no').val(),
                        },
...
$('input[type="radio"]').click(function(){
    ...
    $(".payment-under").not(targetBox).hide();
    $(targetBox).show();
});
$(".checkpayment, .debitbanking").hide();*/
function bankCopy() {
  var copyText = document.getElementById("bankaccountno");
  copyText.select();
  copyText.setSelectionRange(0, 99999)
  document.execCommand("copy");
}
function ifscCodeCopy() {
  var copyText = document.getElementById("ifsccode");
  copyText.select();
  copyText.setSelectionRange(0, 99999)
  document.execCommand("copy");
}
function beneficiaryCopy() {
  var copyText = document.getElementById("beneficiary");
  copyText.select();
  copyText.setSelectionRange(0, 99999)
  document.execCommand("copy");
}
function bankAddressCopy() {
